...
{
    otp_admin_context_t *admin_context = access_otp_admin_context(pico_ward_context);
    ...
    otp_mgr_begin(context->otp_mgr_context, admin_context, otp_main_context, otp_core);
...
bool otp_admin_handle_notification(otp_admin_context_t *admin_context)
{
    ...
    bool notified = context->handle_event_required;
